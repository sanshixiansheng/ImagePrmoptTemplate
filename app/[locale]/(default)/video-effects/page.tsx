...
export const metadata: Metadata = {
  title: "AI Video Effects - Transform Images into Videos | Visora",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Transform static images into stunning videos with Visora AI's innovative templates. Simply upload your photo, choose a professional AI effect, and create stunning videos in minutes - no experience needed. Start now!
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-semibold mb-4 text-foreground">
                FAQs about Visora AI Video Effects
              </h2>
              <p className="text-lg text-muted-foreground">
                Find answers to frequently asked questions about Visora AI video effects.
              </p>
            </div>
