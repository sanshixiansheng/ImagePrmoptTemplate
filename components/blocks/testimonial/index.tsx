    ...
    <section id={section.name} className="py-16 md:py-24">
      <div className="container">
        <div className="mx-auto mb-10 max-w-3xl text-center">
          ...
          <h2 className="mt-4 text-3xl font-semibold tracking-tight md:text-4xl">{section.title}</h2>
      ...
      <div className="lg:container" style={{ margin: "0 auto" }}>
        <Carousel
          ...
          className="relative before:absolute before:bottom-0 before:left-0 before:top-0 before:z-10 before:w-24 before:bg-linear-to-r before:from-background before:to-transparent after:absolute after:bottom-0 after:right-0 after:top-0 after:z-10 after:w-24 after:bg-linear-to-l after:from-background after:to-transparent"
        >
          <CarouselContent>
            {section.items?.map((item, index) => (
              <CarouselItem key={index} className="basis-auto pl-4">
                <Card className="max-w-96 select-none rounded-2xl border-border/60 bg-card p-6 shadow-sm">
                  ...
                  <q className="text-sm leading-7 text-muted-foreground">{item.description}</q>
                </Card>
              </CarouselItem>
            ))}
          </CarouselContent>
