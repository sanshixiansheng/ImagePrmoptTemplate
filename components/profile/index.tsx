        ...
        <div className="container max-w-7xl mx-auto px-4">
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="h-auto bg-transparent border-none gap-6 p-0">
              <TabsTrigger
                value="activity"
                className="data-[state=active]:text-foreground data-[state=active]:bg-transparent data-[state=active]:border-b-2 data-[state=active]:border-primary text-muted-foreground hover:text-foreground rounded-none px-0 py-4 border-b-2 border-transparent transition-all"
              >
